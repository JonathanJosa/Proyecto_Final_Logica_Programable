...
HD_PWD='C:/COD/vivado/proyecto final/proyecto final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_god.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_god.tcl
