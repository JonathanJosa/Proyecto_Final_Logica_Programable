...
HD_PWD='C:/COD/vivado/proyecto final/proyecto final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_god.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_level_god.tcl -notrace
